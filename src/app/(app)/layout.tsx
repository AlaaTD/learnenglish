...
/* The app shell uses the midnight theme from the Sep 2026 redesign: it is always
 * dark, so the `dark` class is forced here and the stored theme preference only
        ...
        <div className="mx-auto flex w-full max-w-[1548px] flex-col gap-3 px-4 pb-[calc(5.5rem+env(safe-area-inset-bottom))] pt-5 text-[13.5px] sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:pb-6">
          <div className="flex items-center gap-3">
            ...
            <p className="text-mist-600">
              <span className="font-semibold text-zinc-100">English90</span>
          ...
          <p className="flex items-center gap-4 italic text-zinc-500">
            <span aria-hidden="true" className="hidden h-px w-14 bg-zinc-700 sm:block" />
