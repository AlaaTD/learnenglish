# -*- coding: utf-8 -*-
"""Data definition for Day 44: Feelings and Emotions."""
...
paras_day44 = [
    {
        ...
        "kind": "informative",
        "text": "When severe natural disasters strike vulnerable towns, families often endure unimaginable agony and mental anguish. The sudden devastation of losing family homes and cherished belongings causes acute emotional distress across entire neighborhoods. Many survivors describe falling into temporary despair when confronted with widespread ruin. In community centers, neighbors share their deep grief and lingering sorrow, comforting mothers who weep openly. Yet amid such heartbreaking misery, volunteers provide warm meals and emotional shelter, proving that human solidarity can illuminate the darkest hours of tragedy.",
    ...
    },
    {
        ...
        "kind": "persuasive",
        "text": "In modern urban life, widespread social apathy and cold indifference can quietly erode community bonds. Much to the dismay of social workers, elderly residents frequently face prolonged loneliness without receiving basic neighborhood checkups. However, showing active compassion and heartfelt sympathy costs nothing and restores trust. When volunteers visit isolated citizens, seniors express profound relief and rediscover precious emotional serenity. Meanwhile, busy professionals who once neglected their families often voice sincere remorse, realizing that meaningful human connection remains far more valuable than unending material pursuits.",
    ...
    },
    {
        ...
        "kind": "reflective",
        "text": "Observing human reactions in high-pressure situations reveals how rapidly collective moods fluctuate. A child’s spontaneous fascination with glittering lights can soften adult stress, yet deep economic discontent frequently stirs unrest. In chaotic trading markets, investors often buy in a sudden frenzy, only to face acute embarrassment when values tumble. Observers watched in complete astonishment as unfounded rumors triggered mass selloffs. While commentators crippled by chronic pessimism forecast endless downturns, quiet moments of reflective melancholy remind us that emotional turbulence is cyclical. Balanced leaders recognize these patterns early, ensuring rational decisions prevail.",
